.. pysetns documentation master file, created by
   sphinx-quickstart on Wed Feb  2 10:50:27 2022.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Welcome to pysetns's documentation!
===================================
.. toctree::
   :maxdepth: 2
   :caption: Contents:

.. image:: https://img.shields.io/pypi/v/pysetns?logo=python&logoColor=white
   :alt: PyPi
   :target: https://pypi.org/project/pysetns/
.. image:: https://img.shields.io/pypi/dm/pysetns?logo=python&logoColor=white
   :alt: PyPI - Downloads
   :target: https://pypi.org/project/pysetns/
...
.. image:: https://img.shields.io/readthedocs/pysetns?logo=readthedocs&logoColor=white
   :alt: Read the Docs
   :target: https://pysetns.readthedocs.io/en/latest
...
Usage
-----
See `examples <https://github.com/baskiton/pysetns/blob/main/examples>`_
